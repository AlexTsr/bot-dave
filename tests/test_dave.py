...
class TestBot(unittest.TestCase):
    ...
    def setUp(self):
        self.event = Event(id=249792023, name="January Event", time=1527344911000, status="upcoming", rsvp_limit=40,
                           ...
                           venue={"name": "STORG Clubhouse"}, participants=[10001, 10002, 10003])
    ...
    def test_event_to_json(self):
        json = '{"event_id": 249792023, "name": "January Event", "time": 1527344911000, "status": "upcoming", ' \
               '"rsvp_limit": 40, "waitlist_count": 10, "yes_rsvp_count": 40, "announced": true, "event_url": ' \
               '"https://www.example.com/Stockholm-Roleplaying-Guild/events/249792023/", "venue": {"name": "STORG ' \
               'Clubhouse"}, "participants": [10001, 10002, 10003]}'
        self.assertEqual(self.event.json(), json)
